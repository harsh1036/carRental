...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2023 at 07:41 AM
...
INSERT INTO `tblbooking` (`id`, `BookingNumber`, `userEmail`, `VehicleId`, `FromDate`, `ToDate`, `message`, `Status`) VALUES
(1, 123456789, 'test@gmail.com', 1, '2023-07-07', '2023-07-09', 'What  is the cost?', 1),
(2, 987456321, 'test@gmail.com', 4, '2023-07-19', '2023-07-24', 'cost?', 1);
...
(1, 'Kunal ', 'kunal@gmail.com', '7977779798', 'branch?\n', 1);
...
INSERT INTO `tblsubscribers` (`id`, `SubscriberEmail`) VALUES
(4, 'harish@gmail.com'),
(5, 'kunal@gmail.com');
...
INSERT INTO `tbltestimonial` (`id`, `UserEmail`, `Testimonial`, `status`) VALUES
(1, 'test@gmail.com', 'I am satisfied with their service great job', 1);
...
INSERT INTO `tblusers` (`id`, `FullName`, `EmailId`, `Password`, `ContactNo`, `dob`, `Address`, `City`) VALUES
(1, 'Test', 'test@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '6465465465', '', 'L-890, Gaur City Ghaziabad', 'Ghaziabad');
